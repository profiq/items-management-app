...
export class InitialSchema1781765203762 implements MigrationInterface {
  name = 'InitialSchema1781765203762';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "item_copy" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "item_id" integer NOT NULL, "location_id" integer NOT NULL, "condition" varchar CHECK( "condition" IN ('good','damaged','lost') ), "archived_at" datetime)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "slack_notification" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "loan_id" integer NOT NULL, "type" varchar(50) NOT NULL, "sent_at" datetime NOT NULL, CONSTRAINT "UQ_ea4d7ae5b5977ab0f1d7c4fb127" UNIQUE ("loan_id", "type"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_item_copy" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "item_id" integer NOT NULL, "location_id" integer NOT NULL, "condition" varchar CHECK( "condition" IN ('good','damaged','lost') ), "archived_at" datetime, CONSTRAINT "FK_7f9ca789538256ddffa030c7987" FOREIGN KEY ("item_id") REFERENCES "item" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_429010cf57c7a5ba9cf5246951f" FOREIGN KEY ("location_id") REFERENCES "location" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "slack_notification" RENAME TO "temporary_slack_notification"`
    );
    await queryRunner.query(
      `CREATE TABLE "slack_notification" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "loan_id" integer NOT NULL, "type" varchar(50) NOT NULL, "sent_at" datetime NOT NULL, CONSTRAINT "UQ_ea4d7ae5b5977ab0f1d7c4fb127" UNIQUE ("loan_id", "type"))`
    );
    await queryRunner.query(
      `INSERT INTO "slack_notification"("id", "loan_id", "type", "sent_at") SELECT "id", "loan_id", "type", "sent_at" FROM "temporary_slack_notification"`
    );
    await queryRunner.query(`DROP TABLE "temporary_slack_notification"`);
    await queryRunner.query(`DROP INDEX "IDX_loan_active_copy_unique"`);
